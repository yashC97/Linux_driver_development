...
#define DEVICE_NAME "myCharDevice4"
#define MODULE_NAME "myCharDriver4"
#define CLASS_NAME "myCharClass4"
...
module_param_string(temp, temp, 5, S_IRUGO | S_IWUSR); // To pass string we do this 
